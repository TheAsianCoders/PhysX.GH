...
{
    public class PxGhRigidDynamicConvexMeshGroup : PxGhRigidDynamic
    {
        public PxGhRigidDynamicConvexMeshGroup(List<Mesh> meshes, Plane frame, Material material, float mass, Vector3d initialLinearVelocity, Vector3d initialAngularVelocity)
...
//        public PxGhRigidDynamicConvexMeshGroup(List<Mesh> meshes, Plane frame, Material material, float mass, Vector3d initialLinearVelocity, Vector3d initialAngularVelocity)
//            : base(frame, mass, initialLinearVelocity, initialAngularVelocity)
//        {
//            DisplayMeshes = new List<Mesh>(meshes);
//
//            foreach (Mesh m in DisplayMeshes)
//            {
//                Mesh mesh = m;
//                mesh.Transform(Transform.PlaneToPlane(frame, Plane.WorldXY));
//
